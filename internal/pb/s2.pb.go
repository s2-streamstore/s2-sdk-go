...
type AccessTokenScope struct {
	...
	Tokens *ResourceSet `protobuf:"bytes,3,opt,name=tokens,proto3" json:"tokens,omitempty"`
...
const file_s2_proto_rawDesc = "" +
	...
	"\x06tokens\x18\x03 \x01(\v2\x17.s2.v1alpha.ResourceSetR\x06tokens\x12A\n" +
	...
	"\x19BASIN_SCOPE_AWS_US_EAST_1\x10\x01*\xfe\x03\n" +
	"\tOperation\x12\x19\n" +
