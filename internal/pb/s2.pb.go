...
type AccessTokenScope struct {
	...
	Basins *ResourceSet `protobuf:"bytes,1,opt,name=basins,proto3,oneof" json:"basins,omitempty"`
	// Stream name restrictions.
	Streams *ResourceSet `protobuf:"bytes,2,opt,name=streams,proto3,oneof" json:"streams,omitempty"`
	// Token ID restrictions.
	Tokens *ResourceSet `protobuf:"bytes,3,opt,name=tokens,proto3,oneof" json:"tokens,omitempty"`
	// Access permissions at operation group level.
	OpGroups *PermittedOperationGroups `protobuf:"bytes,4,opt,name=op_groups,json=opGroups,proto3,oneof" json:"op_groups,omitempty"`
...
func (x *AccessTokenScope) GetTokens() *ResourceSet {
	if x != nil {
		return x.Tokens
	}
	return nil
...
func (x *IssueAccessTokenResponse) GetToken() string {
	if x != nil {
		return x.Token
	}
	return ""
...
const file_s2_proto_rawDesc = "" +
	...
	"\x05limit\x18\x03 \x01(\x04H\x00R\x05limit\x88\x01\x01B\b\n" +
	"\x06_limit\"j\n" +
	"\x18ListAccessTokensResponse\x123\n" +
	"\x06tokens\x18\x01 \x03(\v2\x1b.s2.v1alpha.AccessTokenInfoR\x06tokens\x12\x19\n" +
	...
	"\v_expires_at\"\xd7\x02\n" +
	"\x10AccessTokenScope\x124\n" +
	"\x06basins\x18\x01 \x01(\v2\x17.s2.v1alpha.ResourceSetH\x00R\x06basins\x88\x01\x01\x126\n" +
	"\astreams\x18\x02 \x01(\v2\x17.s2.v1alpha.ResourceSetH\x01R\astreams\x88\x01\x01\x124\n" +
	"\x06tokens\x18\x03 \x01(\v2\x17.s2.v1alpha.ResourceSetH\x02R\x06tokens\x88\x01\x01\x12F\n" +
	"\top_groups\x18\x04 \x01(\v2$.s2.v1alpha.PermittedOperationGroupsH\x03R\bopGroups\x88\x01\x01\x12'\n" +
	"\x03ops\x18\x05 \x03(\x0e2\x15.s2.v1alpha.OperationR\x03opsB\t\n" +
	"\a_basinsB\n" +
	"\n" +
	"\b_streamsB\t\n" +
	"\a_tokensB\f\n" +
...
var file_s2_proto_enumTypes = make([]protoimpl.EnumInfo, 4)
var file_s2_proto_msgTypes = make([]protoimpl.MessageInfo, 53)
var file_s2_proto_goTypes = []any{
	...
	(BasinState)(0),                   // 3: s2.v1alpha.BasinState
	(*ListBasinsRequest)(nil),         // 4: s2.v1alpha.ListBasinsRequest
	(*ListBasinsResponse)(nil),        // 5: s2.v1alpha.ListBasinsResponse
	(*CreateBasinRequest)(nil),        // 6: s2.v1alpha.CreateBasinRequest
	(*CreateBasinResponse)(nil),       // 7: s2.v1alpha.CreateBasinResponse
	(*DeleteBasinRequest)(nil),        // 8: s2.v1alpha.DeleteBasinRequest
	(*DeleteBasinResponse)(nil),       // 9: s2.v1alpha.DeleteBasinResponse
	(*GetBasinConfigRequest)(nil),     // 10: s2.v1alpha.GetBasinConfigRequest
	(*GetBasinConfigResponse)(nil),    // 11: s2.v1alpha.GetBasinConfigResponse
	(*ReconfigureBasinRequest)(nil),   // 12: s2.v1alpha.ReconfigureBasinRequest
	(*ReconfigureBasinResponse)(nil),  // 13: s2.v1alpha.ReconfigureBasinResponse
	(*IssueAccessTokenRequest)(nil),   // 14: s2.v1alpha.IssueAccessTokenRequest
	(*ReadWritePermissions)(nil),      // 15: s2.v1alpha.ReadWritePermissions
	(*PermittedOperationGroups)(nil),  // 16: s2.v1alpha.PermittedOperationGroups
	(*RevokeAccessTokenRequest)(nil),  // 17: s2.v1alpha.RevokeAccessTokenRequest
	(*RevokeAccessTokenResponse)(nil), // 18: s2.v1alpha.RevokeAccessTokenResponse
	(*ListAccessTokensRequest)(nil),   // 19: s2.v1alpha.ListAccessTokensRequest
	(*ListAccessTokensResponse)(nil),  // 20: s2.v1alpha.ListAccessTokensResponse
	(*AccessTokenInfo)(nil),           // 21: s2.v1alpha.AccessTokenInfo
	(*AccessTokenScope)(nil),          // 22: s2.v1alpha.AccessTokenScope
	(*ResourceSet)(nil),               // 23: s2.v1alpha.ResourceSet
	(*IssueAccessTokenResponse)(nil),  // 24: s2.v1alpha.IssueAccessTokenResponse
	(*StreamInfo)(nil),                // 25: s2.v1alpha.StreamInfo
	(*ListStreamsRequest)(nil),        // 26: s2.v1alpha.ListStreamsRequest
	(*ListStreamsResponse)(nil),       // 27: s2.v1alpha.ListStreamsResponse
	(*CreateStreamRequest)(nil),       // 28: s2.v1alpha.CreateStreamRequest
	(*CreateStreamResponse)(nil),      // 29: s2.v1alpha.CreateStreamResponse
	(*DeleteStreamRequest)(nil),       // 30: s2.v1alpha.DeleteStreamRequest
	(*DeleteStreamResponse)(nil),      // 31: s2.v1alpha.DeleteStreamResponse
	(*GetStreamConfigRequest)(nil),    // 32: s2.v1alpha.GetStreamConfigRequest
	(*GetStreamConfigResponse)(nil),   // 33: s2.v1alpha.GetStreamConfigResponse
	(*ReconfigureStreamRequest)(nil),  // 34: s2.v1alpha.ReconfigureStreamRequest
	(*ReconfigureStreamResponse)(nil), // 35: s2.v1alpha.ReconfigureStreamResponse
	(*CheckTailRequest)(nil),          // 36: s2.v1alpha.CheckTailRequest
	(*CheckTailResponse)(nil),         // 37: s2.v1alpha.CheckTailResponse
	(*AppendInput)(nil),               // 38: s2.v1alpha.AppendInput
	(*AppendOutput)(nil),              // 39: s2.v1alpha.AppendOutput
	(*AppendRequest)(nil),             // 40: s2.v1alpha.AppendRequest
	(*AppendResponse)(nil),            // 41: s2.v1alpha.AppendResponse
	(*AppendSessionRequest)(nil),      // 42: s2.v1alpha.AppendSessionRequest
	(*AppendSessionResponse)(nil),     // 43: s2.v1alpha.AppendSessionResponse
	(*ReadOutput)(nil),                // 44: s2.v1alpha.ReadOutput
	(*ReadRequest)(nil),               // 45: s2.v1alpha.ReadRequest
	(*ReadResponse)(nil),              // 46: s2.v1alpha.ReadResponse
	(*ReadLimit)(nil),                 // 47: s2.v1alpha.ReadLimit
	(*ReadSessionRequest)(nil),        // 48: s2.v1alpha.ReadSessionRequest
	(*ReadSessionResponse)(nil),       // 49: s2.v1alpha.ReadSessionResponse
	(*StreamConfig)(nil),              // 50: s2.v1alpha.StreamConfig
	(*BasinConfig)(nil),               // 51: s2.v1alpha.BasinConfig
	(*BasinInfo)(nil),                 // 52: s2.v1alpha.BasinInfo
	(*Header)(nil),                    // 53: s2.v1alpha.Header
	(*AppendRecord)(nil),              // 54: s2.v1alpha.AppendRecord
	(*SequencedRecord)(nil),           // 55: s2.v1alpha.SequencedRecord
	(*SequencedRecordBatch)(nil),      // 56: s2.v1alpha.SequencedRecordBatch
	(*fieldmaskpb.FieldMask)(nil),     // 57: google.protobuf.FieldMask
}
var file_s2_proto_depIdxs = []int32{
	52, // 0: s2.v1alpha.ListBasinsResponse.basins:type_name -> s2.v1alpha.BasinInfo
	51, // 1: s2.v1alpha.CreateBasinRequest.config:type_name -> s2.v1alpha.BasinConfig
	0,  // 2: s2.v1alpha.CreateBasinRequest.scope:type_name -> s2.v1alpha.BasinScope
	52, // 3: s2.v1alpha.CreateBasinResponse.info:type_name -> s2.v1alpha.BasinInfo
	51, // 4: s2.v1alpha.GetBasinConfigResponse.config:type_name -> s2.v1alpha.BasinConfig
	51, // 5: s2.v1alpha.ReconfigureBasinRequest.config:type_name -> s2.v1alpha.BasinConfig
	57, // 6: s2.v1alpha.ReconfigureBasinRequest.mask:type_name -> google.protobuf.FieldMask
	51, // 7: s2.v1alpha.ReconfigureBasinResponse.config:type_name -> s2.v1alpha.BasinConfig
	21, // 8: s2.v1alpha.IssueAccessTokenRequest.info:type_name -> s2.v1alpha.AccessTokenInfo
	15, // 9: s2.v1alpha.PermittedOperationGroups.account:type_name -> s2.v1alpha.ReadWritePermissions
	15, // 10: s2.v1alpha.PermittedOperationGroups.basin:type_name -> s2.v1alpha.ReadWritePermissions
	15, // 11: s2.v1alpha.PermittedOperationGroups.stream:type_name -> s2.v1alpha.ReadWritePermissions
	21, // 12: s2.v1alpha.RevokeAccessTokenResponse.info:type_name -> s2.v1alpha.AccessTokenInfo
	21, // 13: s2.v1alpha.ListAccessTokensResponse.tokens:type_name -> s2.v1alpha.AccessTokenInfo
	22, // 14: s2.v1alpha.AccessTokenInfo.scope:type_name -> s2.v1alpha.AccessTokenScope
	23, // 15: s2.v1alpha.AccessTokenScope.basins:type_name -> s2.v1alpha.ResourceSet
	23, // 16: s2.v1alpha.AccessTokenScope.streams:type_name -> s2.v1alpha.ResourceSet
	23, // 17: s2.v1alpha.AccessTokenScope.tokens:type_name -> s2.v1alpha.ResourceSet
	16, // 18: s2.v1alpha.AccessTokenScope.op_groups:type_name -> s2.v1alpha.PermittedOperationGroups
	1,  // 19: s2.v1alpha.AccessTokenScope.ops:type_name -> s2.v1alpha.Operation
	25, // 20: s2.v1alpha.ListStreamsResponse.streams:type_name -> s2.v1alpha.StreamInfo
	50, // 21: s2.v1alpha.CreateStreamRequest.config:type_name -> s2.v1alpha.StreamConfig
	25, // 22: s2.v1alpha.CreateStreamResponse.info:type_name -> s2.v1alpha.StreamInfo
	50, // 23: s2.v1alpha.GetStreamConfigResponse.config:type_name -> s2.v1alpha.StreamConfig
	50, // 24: s2.v1alpha.ReconfigureStreamRequest.config:type_name -> s2.v1alpha.StreamConfig
	57, // 25: s2.v1alpha.ReconfigureStreamRequest.mask:type_name -> google.protobuf.FieldMask
	50, // 26: s2.v1alpha.ReconfigureStreamResponse.config:type_name -> s2.v1alpha.StreamConfig
	54, // 27: s2.v1alpha.AppendInput.records:type_name -> s2.v1alpha.AppendRecord
	38, // 28: s2.v1alpha.AppendRequest.input:type_name -> s2.v1alpha.AppendInput
	39, // 29: s2.v1alpha.AppendResponse.output:type_name -> s2.v1alpha.AppendOutput
	38, // 30: s2.v1alpha.AppendSessionRequest.input:type_name -> s2.v1alpha.AppendInput
	39, // 31: s2.v1alpha.AppendSessionResponse.output:type_name -> s2.v1alpha.AppendOutput
	56, // 32: s2.v1alpha.ReadOutput.batch:type_name -> s2.v1alpha.SequencedRecordBatch
	47, // 33: s2.v1alpha.ReadRequest.limit:type_name -> s2.v1alpha.ReadLimit
	44, // 34: s2.v1alpha.ReadResponse.output:type_name -> s2.v1alpha.ReadOutput
	47, // 35: s2.v1alpha.ReadSessionRequest.limit:type_name -> s2.v1alpha.ReadLimit
	44, // 36: s2.v1alpha.ReadSessionResponse.output:type_name -> s2.v1alpha.ReadOutput
	2,  // 37: s2.v1alpha.StreamConfig.storage_class:type_name -> s2.v1alpha.StorageClass
	50, // 38: s2.v1alpha.BasinConfig.default_stream_config:type_name -> s2.v1alpha.StreamConfig
	0,  // 39: s2.v1alpha.BasinInfo.scope:type_name -> s2.v1alpha.BasinScope
	3,  // 40: s2.v1alpha.BasinInfo.state:type_name -> s2.v1alpha.BasinState
	53, // 41: s2.v1alpha.AppendRecord.headers:type_name -> s2.v1alpha.Header
	53, // 42: s2.v1alpha.SequencedRecord.headers:type_name -> s2.v1alpha.Header
	55, // 43: s2.v1alpha.SequencedRecordBatch.records:type_name -> s2.v1alpha.SequencedRecord
	4,  // 44: s2.v1alpha.AccountService.ListBasins:input_type -> s2.v1alpha.ListBasinsRequest
	6,  // 45: s2.v1alpha.AccountService.CreateBasin:input_type -> s2.v1alpha.CreateBasinRequest
	8,  // 46: s2.v1alpha.AccountService.DeleteBasin:input_type -> s2.v1alpha.DeleteBasinRequest
	12, // 47: s2.v1alpha.AccountService.ReconfigureBasin:input_type -> s2.v1alpha.ReconfigureBasinRequest
	10, // 48: s2.v1alpha.AccountService.GetBasinConfig:input_type -> s2.v1alpha.GetBasinConfigRequest
	14, // 49: s2.v1alpha.AccountService.IssueAccessToken:input_type -> s2.v1alpha.IssueAccessTokenRequest
	17, // 50: s2.v1alpha.AccountService.RevokeAccessToken:input_type -> s2.v1alpha.RevokeAccessTokenRequest
	19, // 51: s2.v1alpha.AccountService.ListAccessTokens:input_type -> s2.v1alpha.ListAccessTokensRequest
	26, // 52: s2.v1alpha.BasinService.ListStreams:input_type -> s2.v1alpha.ListStreamsRequest
	28, // 53: s2.v1alpha.BasinService.CreateStream:input_type -> s2.v1alpha.CreateStreamRequest
	30, // 54: s2.v1alpha.BasinService.DeleteStream:input_type -> s2.v1alpha.DeleteStreamRequest
	32, // 55: s2.v1alpha.BasinService.GetStreamConfig:input_type -> s2.v1alpha.GetStreamConfigRequest
	34, // 56: s2.v1alpha.BasinService.ReconfigureStream:input_type -> s2.v1alpha.ReconfigureStreamRequest
	36, // 57: s2.v1alpha.StreamService.CheckTail:input_type -> s2.v1alpha.CheckTailRequest
	40, // 58: s2.v1alpha.StreamService.Append:input_type -> s2.v1alpha.AppendRequest
	42, // 59: s2.v1alpha.StreamService.AppendSession:input_type -> s2.v1alpha.AppendSessionRequest
	45, // 60: s2.v1alpha.StreamService.Read:input_type -> s2.v1alpha.ReadRequest
	48, // 61: s2.v1alpha.StreamService.ReadSession:input_type -> s2.v1alpha.ReadSessionRequest
	5,  // 62: s2.v1alpha.AccountService.ListBasins:output_type -> s2.v1alpha.ListBasinsResponse
	7,  // 63: s2.v1alpha.AccountService.CreateBasin:output_type -> s2.v1alpha.CreateBasinResponse
	9,  // 64: s2.v1alpha.AccountService.DeleteBasin:output_type -> s2.v1alpha.DeleteBasinResponse
	13, // 65: s2.v1alpha.AccountService.ReconfigureBasin:output_type -> s2.v1alpha.ReconfigureBasinResponse
	11, // 66: s2.v1alpha.AccountService.GetBasinConfig:output_type -> s2.v1alpha.GetBasinConfigResponse
	24, // 67: s2.v1alpha.AccountService.IssueAccessToken:output_type -> s2.v1alpha.IssueAccessTokenResponse
	18, // 68: s2.v1alpha.AccountService.RevokeAccessToken:output_type -> s2.v1alpha.RevokeAccessTokenResponse
	20, // 69: s2.v1alpha.AccountService.ListAccessTokens:output_type -> s2.v1alpha.ListAccessTokensResponse
	27, // 70: s2.v1alpha.BasinService.ListStreams:output_type -> s2.v1alpha.ListStreamsResponse
	29, // 71: s2.v1alpha.BasinService.CreateStream:output_type -> s2.v1alpha.CreateStreamResponse
	31, // 72: s2.v1alpha.BasinService.DeleteStream:output_type -> s2.v1alpha.DeleteStreamResponse
	33, // 73: s2.v1alpha.BasinService.GetStreamConfig:output_type -> s2.v1alpha.GetStreamConfigResponse
	35, // 74: s2.v1alpha.BasinService.ReconfigureStream:output_type -> s2.v1alpha.ReconfigureStreamResponse
	37, // 75: s2.v1alpha.StreamService.CheckTail:output_type -> s2.v1alpha.CheckTailResponse
	41, // 76: s2.v1alpha.StreamService.Append:output_type -> s2.v1alpha.AppendResponse
	43, // 77: s2.v1alpha.StreamService.AppendSession:output_type -> s2.v1alpha.AppendSessionResponse
	46, // 78: s2.v1alpha.StreamService.Read:output_type -> s2.v1alpha.ReadResponse
	49, // 79: s2.v1alpha.StreamService.ReadSession:output_type -> s2.v1alpha.ReadSessionResponse
...
func file_s2_proto_init() {
	...
	file_s2_proto_msgTypes[18].OneofWrappers = []any{}
