...
const (
	...
	Operation_OPERATION_ACCOUNT_METRICS Operation = 19
	// Retrieve basin-level metrics.
	Operation_OPERATION_BASIN_METRICS Operation = 20
	// Retrieve stream-level metrics.
	Operation_OPERATION_STREAM_METRICS Operation = 21
)
...
var (
	Operation_name = map[int32]string{
		...
		17: "OPERATION_TRIM",
		18: "OPERATION_FENCE",
		19: "OPERATION_ACCOUNT_METRICS",
		20: "OPERATION_BASIN_METRICS",
		21: "OPERATION_STREAM_METRICS",
	}
...
type ReadRequest struct {
	...
	Clamp         bool `protobuf:"varint,7,opt,name=clamp,proto3" json:"clamp,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ReadRequest) GetClamp() bool {
	if x != nil {
		return x.Clamp
	}
	return false
...
type ReadSessionRequest struct {
	...
	// Start reading from the tail if the requested position is beyond it.
	// Otherwise, the next sequence number will be returned.
	Clamp         bool `protobuf:"varint,8,opt,name=clamp,proto3" json:"clamp,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ReadSessionRequest) GetClamp() bool {
	if x != nil {
		return x.Clamp
	}
	return false
...
type StreamConfig struct {
	...
	DeleteOnEmpty *StreamConfig_DeleteOnEmpty `protobuf:"bytes,6,opt,name=delete_on_empty,json=deleteOnEmpty,proto3" json:"delete_on_empty,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *StreamConfig) GetInfinite() *StreamConfig_InfiniteRetention {
	if x != nil {
		if x, ok := x.RetentionPolicy.(*StreamConfig_Infinite); ok {
			return x.Infinite
		}
	}
	return nil
...
func (x *StreamConfig) GetDeleteOnEmpty() *StreamConfig_DeleteOnEmpty {
	if x != nil {
		return x.DeleteOnEmpty
	}
	return nil
}
...
type StreamConfig_Infinite struct {
	// Retain records unless explicitly trimmed.
	Infinite *StreamConfig_InfiniteRetention `protobuf:"bytes,7,opt,name=infinite,proto3,oneof"`
}

func (*StreamConfig_Age) isStreamConfig_RetentionPolicy() {}

func (*StreamConfig_Infinite) isStreamConfig_RetentionPolicy() {}
...
type StreamConfig_DeleteOnEmpty struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Minimum age in seconds before an empty stream can be deleted.
	// Set to 0 (default) to disable (don't delete automatically).
	MinAgeSecs    uint64 `protobuf:"varint,1,opt,name=min_age_secs,json=minAgeSecs,proto3" json:"min_age_secs,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *StreamConfig_DeleteOnEmpty) Reset() {
	*x = StreamConfig_DeleteOnEmpty{}
	mi := &file_s2_proto_msgTypes[54]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *StreamConfig_DeleteOnEmpty) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*StreamConfig_DeleteOnEmpty) ProtoMessage() {}

func (x *StreamConfig_DeleteOnEmpty) ProtoReflect() protoreflect.Message {
	mi := &file_s2_proto_msgTypes[54]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use StreamConfig_DeleteOnEmpty.ProtoReflect.Descriptor instead.
func (*StreamConfig_DeleteOnEmpty) Descriptor() ([]byte, []int) {
	return file_s2_proto_rawDescGZIP(), []int{46, 1}
}

func (x *StreamConfig_DeleteOnEmpty) GetMinAgeSecs() uint64 {
	if x != nil {
		return x.MinAgeSecs
	}
	return 0
...
type StreamConfig_InfiniteRetention struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *StreamConfig_InfiniteRetention) Reset() {
	*x = StreamConfig_InfiniteRetention{}
	mi := &file_s2_proto_msgTypes[55]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *StreamConfig_InfiniteRetention) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*StreamConfig_InfiniteRetention) ProtoMessage() {}

func (x *StreamConfig_InfiniteRetention) ProtoReflect() protoreflect.Message {
	mi := &file_s2_proto_msgTypes[55]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use StreamConfig_InfiniteRetention.ProtoReflect.Descriptor instead.
func (*StreamConfig_InfiniteRetention) Descriptor() ([]byte, []int) {
	return file_s2_proto_rawDescGZIP(), []int{46, 2}
}
...
const file_s2_proto_rawDesc = "" +
	...
	"nextSeqNumB\b\n" +
	"\x06outputJ\x04\b\x02\x10\x03\"\xf4\x01\n" +
	...
	"\x05until\x18\x06 \x01(\x04H\x01R\x05until\x88\x01\x01\x12\x14\n" +
	"\x05clamp\x18\a \x01(\bR\x05clampB\a\n" +
	"\x05startB\b\n" +
	"\x06_until\">\n" +
	"\fReadResponse\x12.\n" +
	...
	"heartbeats\x12\x19\n" +
	"\x05until\x18\a \x01(\x04H\x01R\x05until\x88\x01\x01\x12\x14\n" +
	"\x05clamp\x18\b \x01(\bR\x05clampB\a\n" +
	"\x05startB\b\n" +
	"\x06_until\"U\n" +
	...
	"\x03age\x18\x02 \x01(\x04H\x00R\x03age\x12H\n" +
	"\binfinite\x18\a \x01(\v2*.s2.v1alpha.StreamConfig.InfiniteRetentionH\x00R\binfinite\x12I\n" +
	"\ftimestamping\x18\x05 \x01(\v2%.s2.v1alpha.StreamConfig.TimestampingR\ftimestamping\x12N\n" +
	"\x0fdelete_on_empty\x18\x06 \x01(\v2&.s2.v1alpha.StreamConfig.DeleteOnEmptyR\rdeleteOnEmpty\x1an\n" +
	"\fTimestamping\x120\n" +
	...
	"\t_uncapped\x1a1\n" +
	"\rDeleteOnEmpty\x12 \n" +
	"\fmin_age_secs\x18\x01 \x01(\x04R\n" +
	"minAgeSecs\x1a\x13\n" +
	...
	"\x19BASIN_SCOPE_AWS_US_EAST_1\x10\x01*\x81\x05\n" +
	"\tOperation\x12\x19\n" +
...
var file_s2_proto_msgTypes = make([]protoimpl.MessageInfo, 56)
var file_s2_proto_goTypes = []any{
	...
	(*StreamConfig_DeleteOnEmpty)(nil),     // 59: s2.v1alpha.StreamConfig.DeleteOnEmpty
	(*StreamConfig_InfiniteRetention)(nil), // 60: s2.v1alpha.StreamConfig.InfiniteRetention
...
var file_s2_proto_depIdxs = []int32{
	...
	61, // 6: s2.v1alpha.ReconfigureBasinRequest.mask:type_name -> google.protobuf.FieldMask
	...
	61, // 25: s2.v1alpha.ReconfigureStreamRequest.mask:type_name -> google.protobuf.FieldMask
	...
	60, // 38: s2.v1alpha.StreamConfig.infinite:type_name -> s2.v1alpha.StreamConfig.InfiniteRetention
	58, // 39: s2.v1alpha.StreamConfig.timestamping:type_name -> s2.v1alpha.StreamConfig.Timestamping
	59, // 40: s2.v1alpha.StreamConfig.delete_on_empty:type_name -> s2.v1alpha.StreamConfig.DeleteOnEmpty
	51, // 41: s2.v1alpha.BasinConfig.default_stream_config:type_name -> s2.v1alpha.StreamConfig
	0,  // 42: s2.v1alpha.BasinInfo.scope:type_name -> s2.v1alpha.BasinScope
	4,  // 43: s2.v1alpha.BasinInfo.state:type_name -> s2.v1alpha.BasinState
	54, // 44: s2.v1alpha.AppendRecord.headers:type_name -> s2.v1alpha.Header
	54, // 45: s2.v1alpha.SequencedRecord.headers:type_name -> s2.v1alpha.Header
	56, // 46: s2.v1alpha.SequencedRecordBatch.records:type_name -> s2.v1alpha.SequencedRecord
	3,  // 47: s2.v1alpha.StreamConfig.Timestamping.mode:type_name -> s2.v1alpha.TimestampingMode
	5,  // 48: s2.v1alpha.AccountService.ListBasins:input_type -> s2.v1alpha.ListBasinsRequest
	7,  // 49: s2.v1alpha.AccountService.CreateBasin:input_type -> s2.v1alpha.CreateBasinRequest
	9,  // 50: s2.v1alpha.AccountService.DeleteBasin:input_type -> s2.v1alpha.DeleteBasinRequest
	13, // 51: s2.v1alpha.AccountService.ReconfigureBasin:input_type -> s2.v1alpha.ReconfigureBasinRequest
	11, // 52: s2.v1alpha.AccountService.GetBasinConfig:input_type -> s2.v1alpha.GetBasinConfigRequest
	15, // 53: s2.v1alpha.AccountService.IssueAccessToken:input_type -> s2.v1alpha.IssueAccessTokenRequest
	18, // 54: s2.v1alpha.AccountService.RevokeAccessToken:input_type -> s2.v1alpha.RevokeAccessTokenRequest
	20, // 55: s2.v1alpha.AccountService.ListAccessTokens:input_type -> s2.v1alpha.ListAccessTokensRequest
	27, // 56: s2.v1alpha.BasinService.ListStreams:input_type -> s2.v1alpha.ListStreamsRequest
	29, // 57: s2.v1alpha.BasinService.CreateStream:input_type -> s2.v1alpha.CreateStreamRequest
	31, // 58: s2.v1alpha.BasinService.DeleteStream:input_type -> s2.v1alpha.DeleteStreamRequest
	33, // 59: s2.v1alpha.BasinService.GetStreamConfig:input_type -> s2.v1alpha.GetStreamConfigRequest
	35, // 60: s2.v1alpha.BasinService.ReconfigureStream:input_type -> s2.v1alpha.ReconfigureStreamRequest
	37, // 61: s2.v1alpha.StreamService.CheckTail:input_type -> s2.v1alpha.CheckTailRequest
	41, // 62: s2.v1alpha.StreamService.Append:input_type -> s2.v1alpha.AppendRequest
	43, // 63: s2.v1alpha.StreamService.AppendSession:input_type -> s2.v1alpha.AppendSessionRequest
	46, // 64: s2.v1alpha.StreamService.Read:input_type -> s2.v1alpha.ReadRequest
	49, // 65: s2.v1alpha.StreamService.ReadSession:input_type -> s2.v1alpha.ReadSessionRequest
	6,  // 66: s2.v1alpha.AccountService.ListBasins:output_type -> s2.v1alpha.ListBasinsResponse
	8,  // 67: s2.v1alpha.AccountService.CreateBasin:output_type -> s2.v1alpha.CreateBasinResponse
	10, // 68: s2.v1alpha.AccountService.DeleteBasin:output_type -> s2.v1alpha.DeleteBasinResponse
	14, // 69: s2.v1alpha.AccountService.ReconfigureBasin:output_type -> s2.v1alpha.ReconfigureBasinResponse
	12, // 70: s2.v1alpha.AccountService.GetBasinConfig:output_type -> s2.v1alpha.GetBasinConfigResponse
	25, // 71: s2.v1alpha.AccountService.IssueAccessToken:output_type -> s2.v1alpha.IssueAccessTokenResponse
	19, // 72: s2.v1alpha.AccountService.RevokeAccessToken:output_type -> s2.v1alpha.RevokeAccessTokenResponse
	21, // 73: s2.v1alpha.AccountService.ListAccessTokens:output_type -> s2.v1alpha.ListAccessTokensResponse
	28, // 74: s2.v1alpha.BasinService.ListStreams:output_type -> s2.v1alpha.ListStreamsResponse
	30, // 75: s2.v1alpha.BasinService.CreateStream:output_type -> s2.v1alpha.CreateStreamResponse
	32, // 76: s2.v1alpha.BasinService.DeleteStream:output_type -> s2.v1alpha.DeleteStreamResponse
	34, // 77: s2.v1alpha.BasinService.GetStreamConfig:output_type -> s2.v1alpha.GetStreamConfigResponse
	36, // 78: s2.v1alpha.BasinService.ReconfigureStream:output_type -> s2.v1alpha.ReconfigureStreamResponse
	38, // 79: s2.v1alpha.StreamService.CheckTail:output_type -> s2.v1alpha.CheckTailResponse
	42, // 80: s2.v1alpha.StreamService.Append:output_type -> s2.v1alpha.AppendResponse
	44, // 81: s2.v1alpha.StreamService.AppendSession:output_type -> s2.v1alpha.AppendSessionResponse
	47, // 82: s2.v1alpha.StreamService.Read:output_type -> s2.v1alpha.ReadResponse
	50, // 83: s2.v1alpha.StreamService.ReadSession:output_type -> s2.v1alpha.ReadSessionResponse
