...
var file_s2_proto_msgTypes = make([]protoimpl.MessageInfo, 55)
...
var file_s2_proto_depIdxs = []int32{
	...
	60, // 6: s2.v1alpha.ReconfigureBasinRequest.mask:type_name -> google.protobuf.FieldMask
	...
	60, // 25: s2.v1alpha.ReconfigureStreamRequest.mask:type_name -> google.protobuf.FieldMask
	...
	59, // 39: s2.v1alpha.StreamConfig.delete_on_empty:type_name -> s2.v1alpha.StreamConfig.DeleteOnEmpty
	51, // 40: s2.v1alpha.BasinConfig.default_stream_config:type_name -> s2.v1alpha.StreamConfig
	0,  // 41: s2.v1alpha.BasinInfo.scope:type_name -> s2.v1alpha.BasinScope
	4,  // 42: s2.v1alpha.BasinInfo.state:type_name -> s2.v1alpha.BasinState
	54, // 43: s2.v1alpha.AppendRecord.headers:type_name -> s2.v1alpha.Header
	54, // 44: s2.v1alpha.SequencedRecord.headers:type_name -> s2.v1alpha.Header
	56, // 45: s2.v1alpha.SequencedRecordBatch.records:type_name -> s2.v1alpha.SequencedRecord
	3,  // 46: s2.v1alpha.StreamConfig.Timestamping.mode:type_name -> s2.v1alpha.TimestampingMode
	5,  // 47: s2.v1alpha.AccountService.ListBasins:input_type -> s2.v1alpha.ListBasinsRequest
	7,  // 48: s2.v1alpha.AccountService.CreateBasin:input_type -> s2.v1alpha.CreateBasinRequest
	9,  // 49: s2.v1alpha.AccountService.DeleteBasin:input_type -> s2.v1alpha.DeleteBasinRequest
	13, // 50: s2.v1alpha.AccountService.ReconfigureBasin:input_type -> s2.v1alpha.ReconfigureBasinRequest
	11, // 51: s2.v1alpha.AccountService.GetBasinConfig:input_type -> s2.v1alpha.GetBasinConfigRequest
	15, // 52: s2.v1alpha.AccountService.IssueAccessToken:input_type -> s2.v1alpha.IssueAccessTokenRequest
	18, // 53: s2.v1alpha.AccountService.RevokeAccessToken:input_type -> s2.v1alpha.RevokeAccessTokenRequest
	20, // 54: s2.v1alpha.AccountService.ListAccessTokens:input_type -> s2.v1alpha.ListAccessTokensRequest
	27, // 55: s2.v1alpha.BasinService.ListStreams:input_type -> s2.v1alpha.ListStreamsRequest
	29, // 56: s2.v1alpha.BasinService.CreateStream:input_type -> s2.v1alpha.CreateStreamRequest
	31, // 57: s2.v1alpha.BasinService.DeleteStream:input_type -> s2.v1alpha.DeleteStreamRequest
	33, // 58: s2.v1alpha.BasinService.GetStreamConfig:input_type -> s2.v1alpha.GetStreamConfigRequest
	35, // 59: s2.v1alpha.BasinService.ReconfigureStream:input_type -> s2.v1alpha.ReconfigureStreamRequest
	37, // 60: s2.v1alpha.StreamService.CheckTail:input_type -> s2.v1alpha.CheckTailRequest
	41, // 61: s2.v1alpha.StreamService.Append:input_type -> s2.v1alpha.AppendRequest
	43, // 62: s2.v1alpha.StreamService.AppendSession:input_type -> s2.v1alpha.AppendSessionRequest
	46, // 63: s2.v1alpha.StreamService.Read:input_type -> s2.v1alpha.ReadRequest
	49, // 64: s2.v1alpha.StreamService.ReadSession:input_type -> s2.v1alpha.ReadSessionRequest
	6,  // 65: s2.v1alpha.AccountService.ListBasins:output_type -> s2.v1alpha.ListBasinsResponse
	8,  // 66: s2.v1alpha.AccountService.CreateBasin:output_type -> s2.v1alpha.CreateBasinResponse
	10, // 67: s2.v1alpha.AccountService.DeleteBasin:output_type -> s2.v1alpha.DeleteBasinResponse
	14, // 68: s2.v1alpha.AccountService.ReconfigureBasin:output_type -> s2.v1alpha.ReconfigureBasinResponse
	12, // 69: s2.v1alpha.AccountService.GetBasinConfig:output_type -> s2.v1alpha.GetBasinConfigResponse
	25, // 70: s2.v1alpha.AccountService.IssueAccessToken:output_type -> s2.v1alpha.IssueAccessTokenResponse
	19, // 71: s2.v1alpha.AccountService.RevokeAccessToken:output_type -> s2.v1alpha.RevokeAccessTokenResponse
	21, // 72: s2.v1alpha.AccountService.ListAccessTokens:output_type -> s2.v1alpha.ListAccessTokensResponse
	28, // 73: s2.v1alpha.BasinService.ListStreams:output_type -> s2.v1alpha.ListStreamsResponse
	30, // 74: s2.v1alpha.BasinService.CreateStream:output_type -> s2.v1alpha.CreateStreamResponse
	32, // 75: s2.v1alpha.BasinService.DeleteStream:output_type -> s2.v1alpha.DeleteStreamResponse
	34, // 76: s2.v1alpha.BasinService.GetStreamConfig:output_type -> s2.v1alpha.GetStreamConfigResponse
	36, // 77: s2.v1alpha.BasinService.ReconfigureStream:output_type -> s2.v1alpha.ReconfigureStreamResponse
	38, // 78: s2.v1alpha.StreamService.CheckTail:output_type -> s2.v1alpha.CheckTailResponse
	42, // 79: s2.v1alpha.StreamService.Append:output_type -> s2.v1alpha.AppendResponse
	44, // 80: s2.v1alpha.StreamService.AppendSession:output_type -> s2.v1alpha.AppendSessionResponse
	47, // 81: s2.v1alpha.StreamService.Read:output_type -> s2.v1alpha.ReadResponse
	50, // 82: s2.v1alpha.StreamService.ReadSession:output_type -> s2.v1alpha.ReadSessionResponse
