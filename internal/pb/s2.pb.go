...
type StreamConfig struct {
	...
	UncappedClientTimestamps *bool `protobuf:"varint,4,opt,name=uncapped_client_timestamps,json=uncappedClientTimestamps,proto3,oneof" json:"uncapped_client_timestamps,omitempty"`
	unknownFields            protoimpl.UnknownFields
	sizeCache                protoimpl.SizeCache
}
...
func (x *StreamConfig) GetUncappedClientTimestamps() bool {
	if x != nil && x.UncappedClientTimestamps != nil {
		return *x.UncappedClientTimestamps
	}
	return false
}
...
const file_s2_proto_rawDesc = "" +
	...
	"\x19require_client_timestamps\x18\x03 \x01(\bH\x01R\x17requireClientTimestamps\x88\x01\x01\x12A\n" +
	"\x1auncapped_client_timestamps\x18\x04 \x01(\bH\x02R\x18uncappedClientTimestamps\x88\x01\x01B\x12\n" +
	"\x10retention_policyB\x1c\n" +
	"\x1a_require_client_timestampsB\x1d\n" +
	"\x1b_uncapped_client_timestamps\"\xc5\x01\n" +
	"\vBasinConfig\x12L\n" +
