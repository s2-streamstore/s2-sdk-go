...
> - The PUT based API for CreateOrReconfigure is exposed in the SDK as `basin.Streams.Ensure()`; implement tests for it
...
- **start_after < prefix**
  - Setup: create streams `{base}-a-a`, `{base}-a-b`, `{base}-b-a`
